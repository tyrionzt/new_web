...
TEMPLATE : Avec - Creative Coming Soon Template
VERSION  : 1.0
...
(function ($) {
    ...
    */
    ...
    $.bg_urls = ["img/background/sample1.jpg"]; 						//-- fallback background on small devices
    $.youtube_url = "ahlywIKP5_c"; 									//-- just the last words after https://www.youtube.com/watch?v=
            ...
            submitHandler: function (form) {
                ...
                $.post(url_dest, form_data, function (data) {
                    ...
                    if (success) {
                        ...
                        var show_notif = setTimeout(function () {
                            $(form).find('.form-notif').find('label').remove();
                            $(form).find('.form-notif').append('<label class="notif-success">成功！！！感谢留言，您可以在留言板查看所有留言</label>');
                            $(form).find('.form-notif').addClass('is-visible');
